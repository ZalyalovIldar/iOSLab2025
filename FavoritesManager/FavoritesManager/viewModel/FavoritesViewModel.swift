...
enum FavoritesSort: String, CaseIterable, Identifiable {
    ...
    case byTitleAsc = "By Title (A–Z)"
    case byAuthorAsc = "By Author (A–Z)"
...
final class FavoritesViewModel {
    ...
    var displayedFavorites: [FavoriteBook] {
        ...
        case .byAuthorAsc:
            items.sort { $0.author.localizedCaseInsensitiveCompare($1.author) == .orderedAscending }
        }

        return items
    }

    func add(title: String, author: String, coverImageData: Data?) {
        let new = FavoriteBook(title: title, author: author, coverImageData: coverImageData)
    ...
    func update(id: UUID, title: String, author: String, coverImageData: Data?) {
